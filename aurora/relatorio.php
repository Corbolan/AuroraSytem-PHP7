...
<table style="border:1px solid black; background-color:white; border-left: 1px solid black;border-collapse: collapse;">
			<tr style="border:1px solid black;">
				...
				<th style="border:1px solid black;padding:10px;padding-right:370px;">Descrição</th>
				<th style="border:1px solid black;padding:10px;padding-right:70px;">Quantidade</th>
				<th style="border:1px solid black;padding:10px;padding-right:70px;">Validade</th>
				<th style="border:1px solid black;padding:10px;padding-right:70px;">Preço Tabela</th>
			</tr>
